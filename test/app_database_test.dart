...
void main() {
  ...
  test('sürüm 1 veritabanını sürüm 4e taşır', () async {
    ...
    expect(versionRows.single.values.single, 4);
    ...
    expect(
      ...
      contains('room_start_number'),
    );
    expect(
      tables.map((row) => row['name']),
      containsAll(['schools', 'students', 'student_attendance']),
    );
    expect(
